  ...
  return knex('System_Parameter').del()
    .then(function () {
      return knex('System_Parameter').insert([
        ...
        { Id: 4, Key: 'EMAIL_ACCOUNT', KeyName: 'Email Account', Value: 'beosogoodno1@gmail.com', BoolValue: null },
        { Id: 5, Key: 'EMAIL_PASS', KeyName: 'Email Account Pass', Value: 'xujximslqhygzice', BoolValue: null },
        { Id: 6, Key: 'EMAIL_RECEIPT_DEFAUT', KeyName: 'Email Receipt default', Value: null, BoolValue: true },
        { Id: 7, Key: 'EMAIL_RECEIPT_ACCOUNT', KeyName: 'Email Receipt Account', Value: 'truong6112000@gmail.com', BoolValue: null },
      ]);
    });
};
